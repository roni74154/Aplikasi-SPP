         ...
         <div class="card">
            <div class="card-body">
              ...
              <p class="text-muted">Tambah data pegawai</p>
               ...
               <form action="tambah_aksi_pegawai.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label>Nip</label>
                    <input type="number" name="nip" class="form-control" required autocomplete="off" placeholder="masukan nip pegawai" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                </div>
                <div class="form-group">
                    <label>Nama</label>
                    <input type="text" name="nama" class="form-control" required autocomplete="off" placeholder="masukan nama pegawai">
                </div>
                <div class="form-group">
                    <label>Gender</label>
                 ...
                 <div class="form-group">
                    <label>Jabatan</label>
                    <input type="text" name="jabatan" class="form-control" required autocomplete="off" placeholder="masukan jabatan">
                </div>
                <div class="form-group">
                    <label>Alamat</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="t_lahir" class="form-control" required autocomplete="off" placeholder="masukan tempat tanggal lahir">
                </div>
                <div class="form-group">
                    <label>Tgl_lahir</label>
                    <input type="date" name="tgl_lahir" class="form-control" required autocomplete="off" placeholder="masukan nomor hp">
                </div>
                 <div class="form-group">
                    <label>No.hp</label>
                    <input type="number" name="nohp" class="form-control" required autocomplete="off" placeholder="masukan nomor hp" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                </div>
                <div class="form-group">
                    <label>Agama</label>
